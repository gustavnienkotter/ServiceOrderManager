...
<br>Ps.: User classes dont use projections because admin is the only user with access to the endpoint, but is interesting to change then to use projection to put more security and avoid someone to enter in other user, but for the tests of this project I decided not to put projection on these classes
